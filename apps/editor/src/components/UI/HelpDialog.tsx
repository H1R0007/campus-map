...
const MOUSE: [string, string][] = [
  ...
  ['Shift + щелчок инструментом «Узел»', 'связать новую точку с предыдущей поставленной — точка внутри большого кабинета'],
  ['Alt + щелчок', 'поставить точку ровно туда, куда щёлкнули, без выравнивания'],
...
const RECIPES: [string, string][] = [
  ...
  [
    'Лестницы одна над другой',
    'Включите «Соседний этаж бледно» в левой колонке: план и точки соседнего этажа видны сквозь открытый.',
  ],
  [
    'Свой вид точки',
  ...
  [
    ...
    'Вид «Коридор» (цифра 1) и щелчки вдоль прохода: каждая точка связывается с предыдущей, пунктир показывает, куда пойдёт следующая. Enter или Esc — закончить. Прямой отрезок с равными промежутками — инструмент «Линия» (L).',
  ],
  [
    'Найти ошибки',
