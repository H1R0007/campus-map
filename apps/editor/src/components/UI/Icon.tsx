...
const ICON_PATHS = {
  ...
  // Виды мест — те же контуры, что у навигатора: туалет (две фигуры), еда
  // (вилка и нож), гардероб (вешалка), выход (дверь со стрелкой). Разметчик
  // видит на кисти ровно то, что потом увидит студент.
  toilet:
