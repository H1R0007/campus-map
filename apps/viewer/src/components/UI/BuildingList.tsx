...
/**
 * Корпуса, найденные поиском по названию; выбор открывает этаж, открытый в
 * корпусе последним, а впервые — входной.
 *
 * Список всех корпусов здесь не показывается: корпус выбирают в шапке
 * (`BuildingMenu`, запись 37).
 */
