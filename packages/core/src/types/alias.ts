...
export interface SearchSuggestion {
  ...
  /**
   * Место нашлось по слову своей категории («туалет», «поесть»), а не по имени.
   * `alias` тогда — это слово, и показывать его как имя места нельзя.
   */
  viaCategory?: PlaceCategory;
}
